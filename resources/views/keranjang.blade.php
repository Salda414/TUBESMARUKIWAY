  ...
  <div class="offcanvas-body">
    <div class="order-md-last">
      <h4 class="d-flex justify-content-between align-items-center mb-3">
        <span class="text-primary">Jumlah produk</span>
              ...
              <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                ...
                <div class="col">
                  <div class="product-item">
                    ...
                    <h3>{{$p->nama_produk}}</h3>
                    <span class="qty">Jumlah Pembelian: {{ $p->total_produk }} Unit</span><br>
                    <span class="qty"><b>Total : {{rupiah($p->total_belanja)}}</b></span> <br>
                    <button class="w-100 btn btn-danger btn-sm" type="submit" onclick="hapus({{ $p->produk_id }})">Hapus</button>
                  </div>
                </div>
                @endforeach
              </div>
  ...
  function hapus(produk_id) {
        ...
        .then(data => {
            if (data.success) {
                ...
                // jmlprodukdibeli
                document.getElementById('cart-count').textContent = data.jmlprodukdibeli;
