    ...
    <defs>
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="close" viewBox="0 0 15 15">
          <path fill="currentColor" d="M7.953 3.788a.5.5 0 0 0-.906 0L6.08 5.85l-2.154.33a.5.5 0 0 0-.283.843l1.574 1.613l-.373 2.284a.5.5 0 0 0 .736.518l1.92-1.063l1.921 1.063a.5.5 0 0 0 .736-.519l-.373-2.283l1.574-1.613a.5.5 0 0 0-.283-.844L8.921 5.85l-.968-2.062Z" />
            ...
            <!-- Tambahkan simbol lainnya di sini -->
      </defs>
    </svg>
    ...
    <div class="offcanvas-body">
      <div class="order-md-last">
        ...
        <li class="list-group-item d-flex justify-content-between lh-sm">
          <span>Total (IDR)</span>
          <strong id="cart-total">IDR {{rupiah($total_belanja) ?? 0}}</strong>
        ...
        <ul class="d-flex justify-content-end list-unstyled m-0">
          <li>
            <a href="{{ url('/ubahpassword') }}" class="rounded-circle bg-light p-2 mx-1">
              <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#user"></use>
                    ...
                    <div class="product-item bg-white p-3 rounded shadow-sm">
                      ...
                      <figure class="text-center mb-4">
                        <a href="{{ asset('storage/' . $p->gambar) }}" title="{{ $p->nama_produk }}">
                          <img src="{{ asset('storage/' . $p->gambar) }}" class="tab-image img-fluid" alt="{{ $p->nama_produk }}" style="width: 100%; height: 200px; object-fit: cover; border-radius: 8px;">
                        </a>
                        </figure>
                        <div class="product-details">
                          <h2 class="text-xl font-semibold mb-2 text-center leading-tight">{{ $p->nama_produk }}</h2>
                        ...
                        <div class="price-wrap mb-3">
                          <span class="price fs-5 fw-bold text-primary">Rp {{ number_format($p->harga) }}</span>
                        </div>       
