            ...
            <div class="order-md-last">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-sm">
                        <span>Total (IDR)</span>
                        <strong id="cart-total">IDR {{ number_format($total_belanja ?? 0, 0, ',', '.') }}</strong>
              ...
              <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#user"></use></svg>
                    ...
                    <div class="cart text-end d-none d-lg-block dropdown">
                        <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                            ...
                            <span class="cart-total fs-5 fw-bold" id="total_belanja"> IDR {{ number_format($total_belanja ?? 0, 0, ',', '.') }}</span>
            </button>
                        </button>
                    </div>
                </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                          ...
                          <span class="rating d-flex align-items-center">
                            ...
                            {{ $p->rating }}
                                            ...
                                            <span class="price">IDR {{ number_format($p->harga, 0, ',', '.') }}</span>
                                            <div class="d-flex flex-column align-items-center">
                                              <div class="d-flex mb-2">
                                                <button class="btn btn-danger">-</button>
                                                  <input type="text" class="form-control mx-1" value="1" style="width: 60px;">
